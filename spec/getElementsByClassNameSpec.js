...
//LOOK AT NODE ELMENTS FOR CLASSES

//got to MDN see HTML nodes 
//node elements
//every html element when you access it with a specific JS
//each node has properties
//one of those properties is classes
//get all elements of the document
//looop thru each one
//if you do that. you append that to an array
//then you have an array of all elements of that class
//return that array
